...
interface NavbarProps {
  ...
  activeTab?: 'focus' | 'leaderboard' | 'history';
  onTabChange?: (tab: 'focus' | 'leaderboard' | 'history') => void;
}
          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-60 rounded-2xl bg-white dark:bg-[#121215] border border-zinc-200 dark:border-white/[0.12] p-2 z-50 animate-in fade-in slide-in-from-top-2 text-zinc-900 dark:text-zinc-100 shadow-2xl ring-1 ring-black/5 dark:ring-white/5">
                ...
                <div className="px-3 py-2 flex items-center justify-between text-xs font-semibold text-zinc-600 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-800/40 rounded-xl mb-1 border border-zinc-200/50 dark:border-zinc-700/50">
                  <span className="flex items-center gap-1.5">
                    <Target className="w-3.5 h-3.5 text-emerald-500" />
                    <span>Target: {todayTargetHours}h / day</span>
                  </span>
                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-zinc-200/60 dark:bg-zinc-700/60 text-[10px] font-mono text-zinc-500 dark:text-zinc-300" title="Locked until 2:00 AM reset">
